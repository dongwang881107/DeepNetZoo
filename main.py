...
if __name__ == "__main__":
    ...
    subparser_train.add_argument('--num_iters', type=int, default=2, help='number of iterations to train discriminator in each epoch')
    ...
    subparser_plot.add_argument('--data_path', type=str, default='/Users/dong/Documents/Data/pet/testing/')
